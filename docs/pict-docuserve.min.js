 ...
 */
M.stemmer=(t={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},n={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},s="^("+(i="[^aeiou][^aeiouy]*")+")?"+(a=(r="[aeiouy]")+"[aeiou]*")+i+"("+a+")?$",l="^("+i+")?"+a+i+a+i,c="^("+i+")?"+r,d=new RegExp("^("+i+")?"+a+i),p=new RegExp(l),h=new RegExp(s),u=new RegExp(c),m=/^(.+?)(ss|i)es$/,g=/^(.+?)([^s])s$/,f=/^(.+?)eed$/,b=/^(.+?)(ed|ing)$/,v=/.$/,y=/(at|bl|iz)$/,w=new RegExp("([^aeiouylsz])\\1$"),D=new RegExp("^"+i+r+"[^aeiouwxy]$"),x=/^(.+?[^aeiou])y$/,C=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,T=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,S=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,A=/^(.+?)(s|t)(ion)$/,k=/^(.+?)e$/,P=/ll$/,F=new RegExp("^"+i+r+"[^aeiouwxy]$"),_=function(e){var o,r,i,a,s,l,c;if(e.length<3)return e;if("y"==(i=e.substr(0,1))&&(e=i.toUpperCase()+e.substr(1)),s=g,(a=m).test(e)?e=e.replace(a,"$1$2"):s.test(e)&&(e=e.replace(s,"$1$2")),s=b,(a=f).test(e)){var _=a.exec(e);(a=d).test(_[1])&&(a=v,e=e.replace(a,""))}else s.test(e)&&(o=(_=s.exec(e))[1],(s=u).test(o)&&(l=w,c=D,(s=y).test(e=o)?e+="e":l.test(e)?(a=v,e=e.replace(a,"")):c.test(e)&&(e+="e")));return(a=x).test(e)&&(e=(o=(_=a.exec(e))[1])+"i"),(a=C).test(e)&&(o=(_=a.exec(e))[1],r=_[2],(a=d).test(o)&&(e=o+t[r])),(a=T).test(e)&&(o=(_=a.exec(e))[1],r=_[2],(a=d).test(o)&&(e=o+n[r])),s=A,(a=S).test(e)?(o=(_=a.exec(e))[1],(a=p).test(o)&&(e=o)):s.test(e)&&(o=(_=s.exec(e))[1]+_[2],(s=p).test(o)&&(e=o)),(a=k).test(e)&&(o=(_=a.exec(e))[1],s=h,l=F,((a=p).test(o)||s.test(o)&&!l.test(o))&&(e=o)),s=p,(a=P).test(e)&&s.test(e)&&(a=v,e=e.replace(a,"")),"y"==i&&(e=i.toLowerCase()+e.substr(1)),e},function(t){return t.update(_)}),M.Pipeline.registerFunction(M.stemmer,"stemmer"),
/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
 */
